...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <br>
                <h1 class="fw-bold mb-3">Calendar</h1>
                <p class="synced-account">
                    Google Synced Account: <span class="email">superadmin1@booking.com</span>
                </p>
                <div id="calendar"></div>
            </div>
        </div>
    ...
    <script>
        ...
        function save_event() {
            ...
            if (event_start_date === "" || event_time === "" || isNaN(event_duration)) {
